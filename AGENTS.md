...
- Pavel is technical and works directly in the codebase. He makes his own structural and architectural decisions and informs Codex after the fact. Codex's role is to provide working implementations and diagnose bugs — not to second-guess structural choices.
